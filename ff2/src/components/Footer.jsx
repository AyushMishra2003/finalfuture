...
const Footer = () => {
  ...
  // Show the mobile bottom tab bar only on the home page; hide it everywhere else
  ...
  return (
    <>
      ...
      {/* Mobile bottom nav — mobile only, shown only on the home page */}
      {showMobileNav && (
      <footer className="mobile-footer d-md-none">
        ...
        <Link to="/offer" aria-label="Offers">
