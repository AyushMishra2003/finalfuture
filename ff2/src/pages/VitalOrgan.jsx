...
const VitalOrgan = () => {
  ...
  useEffect(() => {
    const fetchTabs = async () => {
      try {
        const response = await apiService.getSelectedVitalOrgans();
  ...
  return (
    <div className="vital-organ-page">
      <div className="container py-5">
        <h2 className="mb-4">Vital Organ Health Checkups</h2>
