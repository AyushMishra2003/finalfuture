          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-3 col-md-3 col-sm-12 col-12 py-lg-3 py-md-2 d-flex align-items-center justify-content-end gap-2">
              ...
              {isLoggedIn ? (
                ...
                <button
                  className="login-button d-none d-md-inline-block"
          ...
          <div className="row p-1">
            ...
            <div className="col-6 text-end p-2">
              ...
              {isLoggedIn ? (
                ...
                <button
                  className="login-button d-md-none ms-2"
                  id="login-button-mobile"
                  style={{ padding: '8px 16px 8px 35px', fontSize: '13px' }}
                  onClick={(e) => {
                    addRippleEffect(e);
                    setIsSidebarOpen(true);
                  }}
                >
                  <img
                    src={`${process.env.PUBLIC_URL}/images/icon-svg/login.svg`}
                    className="login-icon"
                    style={{ left: '10px', width: '18px', height: '18px' }}
                    alt="Login"
                  />
                  Login
                </button>
